:: Windows 10 Reforged Gaming Edition Pre/Post-AME Script
:: v4.20.24.10
...
:menu
	cls
	echo.
	echo  :: WINDOWS 10 Reforged Gaming Edition AME SETUP SCRIPT Version 20.24.10
	echo. 
	echo     This script gives you a list-style overview to execute many commands
	echo. 
	echo  :: NOTE: For Windows 10 Builds 2004 and 2004 H2 Only
	echo. 
...
:: Editing Hosts File, placebo (removed)
cls
